...
if __name__ == "__main__":    
	...
	for path in evtx_dict:
    	...
    	#query = "SELECT * FROM eventlog WHERE (Channel = \"System\" AND EventID IN (\"5805\", \"5723\") AND (eventlog MATCH ('\"kali\" OR \"mimikatz\"')))"
    	#print(query)
	...
	eventlog.to_csv(os.path.join(path,'eventlog.csv'), encoding='utf-8')